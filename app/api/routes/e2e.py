...
from app.models import E2ECase, E2ERun, Page, TrendPoint
...
@router.get("/trends/suites/{suite}", response_model=Page[TrendPoint])
async def e2e_suite_trend(
    suite: str,
    repository: E2ERepositoryDependency,
    stage: str | None = None,
    target: str | None = None,
